      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return transporter.sendMail({
            from: '"Công Hùng 👻" <conghung294@gmail.com>',
            // sender address
...
var getBodyHTMLEmailRemedy = function getBodyHTMLEmailRemedy(dataSend) {
  var result = '';
  if (dataSend.language === 'vi') {
    result = "\n    <h3>Xin ch\xE0o ".concat(dataSend.patientName, "!</h3>\n    <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC \u0111\xE3 \u0111\u1EB7 l\u1ECBch kh\xE1m b\u1EC7nh online tr\xEAn Booking Care th\xE0nh c\xF4ng</p>\n    <p> Th\xF4ng tin c\u1EE7a \u0111\u01A1n thu\u1ED1c \u0111\u01B0\u1EE3c g\u1EEDi trong file \u0111\xEDnh k\xE8m <p/>\n\n    <div> Xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n </div>\n\n    ");
  }
  if (dataSend.language === 'en') {
    result = "\n    <h3>Xin ch\xE0o ".concat(dataSend.patientName, "!</h3>\n    <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC \u0111\xE3 \u0111\u1EB7 l\u1ECBch kh\xE1m b\u1EC7nh online tr\xEAn Booking Care th\xE0nh c\xF4ng</p>\n    <p> Th\xF4ng tin c\u1EE7a \u0111\u01A1n thu\u1ED1c \u0111\u01B0\u1EE3c g\u1EEDi trong file \u0111\xEDnh k\xE8m <p/>\n\n    <div> Xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n </div>\n\n    ");
  }
