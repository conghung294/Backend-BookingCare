...
var handleUserLogin = function handleUserLogin(email, password) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var userData, isExistUserEmail, user, passwordDb, check;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            isExistUserEmail = _context.sent;
            if (!isExistUserEmail) {
              _context.next = 21;
              break;
            }
          ...
          case 8:
            ...
            _context.next = 13;
            return _bcryptjs["default"].compareSync(password, passwordDb);
          case 13:
            check = _context.sent;
            if (check) {
              userData.errCode = 0;
      ...
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          if (userId && userId !== 'ALL') {
            users = _index["default"].User.findOne({
              where: {
                id: userId
              },
              attributes: {
...
var getAllCodeService = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(type) {
    var data;
